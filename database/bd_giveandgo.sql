...
(2, 'Fundación Bogotá Solidaria', 'Carrera 80 # 40B Sur-12, Castilla, Bogotá D.C.', '+57 300 000 0000', 'info@bogotasolidaria.org', '$2b$10$gO6NveiB/s/T.O3m/v9L1e7pAAAsH1.S2Zp1A/9oK32V9R1pW52aD.', 'Fundación sin ánimo de lucro enfocada en desarrollo ambiental y apoyo pedagógico', '901.809.708-24', 'Apoyar a adultos mayores en situación de vulnerabilidad', 'Ser referente en asistencia social en Bogotá'), 
(3, 'Asociación Social Ciudad Kennedy', 'Avenida Ciudad de Cali # 13-08, Patio Bonito, Bogotá D.C.', '+57 300 000 0000', 'hola@ciudadkennedy.org', '$2b$10$gO6NveiB/s/T.O3m/v9L1e7pAAAsH1.S2Zp1A/9oK32V9R1pW52aD.', 'Organización para la recuperación ambiental y el apoyo pedagógico', '901.809.708-25', 'Recuperar espacios verdes en la localidad de Kennedy', 'Ser la organización líder en recuperación ambiental en Bogotá');
-- Eventos iniciales
