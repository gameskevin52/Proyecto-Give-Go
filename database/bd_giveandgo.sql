...
-- 2. Tabla de Categorías de Eventos / Donaciones
...
-- 4. Tabla de Auditorías / Registro de Actividades
...
-- 5. Tabla de Solicitudes de Beneficiarios
...
-- 7. Tabla de Eventos de Voluntariado
...
-- 8. Tabla de Cabecera de Donaciones
...
-- 9. Tabla de Donaciones Monetarias
...
-- 10. Tabla de Donaciones de Objetos (Especie)
...
-- 11. Tabla de Postulaciones a Eventos (Voluntarios y Beneficiarios)
...
-- 12. Tabla de Inscripciones a Eventos (Compatibilidad Seguimiento de Eventos)
