import type { AccessibilityProps, Insets, PressableAndroidRippleConfig as RNPressableAndroidRippleConfig, PressableStateCallbackType as RNPressableStateCallbackType, StyleProp, View, ViewProps, ViewStyle } from 'react-native';
