...
interface IniciarSesionProps {
  onVolverInicio: () => void;
  onIrARegistro: () => void;
  onLoginExitoso?: (usuario: UsuarioDB) => void;
}
...
export const IniciarSesion: React.FC<IniciarSesionProps> = ({
  ...
  const [sessionUser, setSessionUser] = useState<UsuarioDB | null>(null);
      ...
      <div className="space-y-4">
        ...
        <div className="pt-2 border-t border-slate-100">
          ...
          <div className="grid grid-cols-2 gap-1.5">
            <button
              type="button"
              onClick={() => handleQuickFill('voluntario@giveandgo.org')}
            ...
            >
              ...
              voluntario@giveandgo.org
            </button>
            <button
              type="button"
              onClick={() => handleQuickFill('contacto@fundacion.org')}
              className="px-2 py-1.5 rounded-lg bg-slate-50 hover:bg-slate-100 text-slate-600 text-[10px] text-left border border-slate-200 truncate cursor-pointer"
            >
